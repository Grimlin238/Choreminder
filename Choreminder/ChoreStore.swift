...
class ChoreStore: ObservableObject {
    ...
    @Published var helpItems: [Help] = [
        ...
        Help(header: "Create", body: "So you want to create a chore? Just tap the Create a chore tab. Next, type what you want, to be reminded about set a due date, time, and leave repeating as none if you don't want the chore to repeatedly remind you. When finished, tap Add To Chores."),
