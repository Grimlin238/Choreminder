...
class ChoreStore: ObservableObject {
    ...
    @Published var helpItems: [Help] = [
        ...
        Help(header: "Reminding you to Open the App Everyday", body: "Chore can remind you to open the app everyday. Sometimes, we need a nudge, and Chore is here to do exactly that.\nTap more, then Settings. In settings, you can adjust the Remind me everyday at, insert time, A.M. of chores I have upcoming foer the day., picker from 5:00AM to 11:00AM. Note: do to iOS system limitations, Chore might remind you later then expected. If you aren't using Chore frequently, iOS will not prioritize Chore."),
